    ...
    public final boolean onActivityResult(Activity currentActivity, int requestCode, int resultCode, Intent data) {
        ...
        if (data != null) {
            ...
            if (result != null) {
                ...
                return authorizationClient.onActivityResult(requestCode, resultCode, data);
                // Assuming this will always work is bad practice, 
                // Changed from "return true" to return the real value of authorizationClient.onActivityResult 
            }

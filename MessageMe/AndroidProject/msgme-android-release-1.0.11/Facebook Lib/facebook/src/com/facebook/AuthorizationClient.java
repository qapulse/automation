...
class AuthorizationClient implements Serializable {
    ...
    class KatanaLoginDialogAuthHandler extends KatanaAuthHandler {
        ...
        boolean onActivityResult(int requestCode, int resultCode, Intent data) {
            ...
            if(data == null){
            // Crash reflected in this stacktrace is cause because Intent data is null
            // Caused by: java.lang.NullPointerException
            // com.facebook.NativeProtocol.isServiceDisabledResult20121101(NativeProtocol.java:238)
            // com.facebook.AuthorizationClient$KatanaLoginDialogAuthHandler.onActivityResult(AuthorizationClient.java:587)
                Log.w("MessageMe", "Null intent in Facebook SDK, ignore it");
                return false;
            }

...
public class WebSocketConnection implements WebSocket {
   ...
   public boolean sendRawTextMessage(byte[] payload) {
       if(isConnected() && mWriter != null){
   ...
   public boolean sendBinaryMessage(byte[] payload) {
       if(isConnected() && mWriter != null){
      ...
      mMasterHandler = new Handler() {
         ...
         public void handleMessage(Message msg) {
            ...
            if (msg.obj instanceof WebSocketMessage.TextMessage) {
               ...
               if(mWsHandler != null){
                   mWsHandler.onPongReceived(pong.mPayload);
               }else{
                   if (DEBUG) Log.d(TAG, "could not call onPongReceived() .. handler already NULL");
               }
   ...
   protected void createReader() {
    ...
    /* 
     * Extracted sendPing Method in order to do a manual ping
     */

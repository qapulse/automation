...
import com.coredroid.ui.CoreListActivity;
...
public class MessageMeListActivity extends CoreListActivity {
    ...
    protected void onPause() {
        super.onPause();
        MessageMeApplication.appIsInactive(MessageMeListActivity.this, mMessagingServiceRef);
    }
    ...
    private BroadcastReceiver connectionChangeReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context ctx, Intent intent) {
            if (NetUtil.checkInternetConnection(MessageMeListActivity.this)) {
                LogIt.d(MessageMeListActivity.class, "Connection restored");
                MessageMeApplication.appIsActive(MessageMeListActivity.this,
                        mMessagingServiceRef);
            } else {
                LogIt.d(MessageMeListActivity.class, "Connection lost");
            }
        }
    };
    ...
    private BroadcastReceiver screenReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context ctx, Intent intent) {
            ...
            MessageMeApplication.onScreenChange(isScreenOn,
                    MessageMeListActivity.this, mMessagingServiceRef);
        }
    };
    ...
    private BroadcastReceiver invalidUserIdentifierReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context ctx, Intent intent) {
            ...
            if (extras.getBoolean(MessageMeConstants.USER_IDENTIFIER_FAILED,
                    false)) {
                LogIt.d(MessageMeListActivity.class,
                        "Received USER_IDENTIFIER_FAILED, starting app logout");
                // Execute the logout
                LogOutUtil.logoutUser(MessageMeListActivity.this,
                        mMessagingServiceRef);
            }
        }
    };
    ...
    private ServiceConnection messagingServiceConnection = new ServiceConnection() {
        ...
        public void onServiceConnected(ComponentName name, IBinder service) {
            LogIt.d(MessageMeListActivity.class, "Connected to Messaging Service");

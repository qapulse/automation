...
import com.littleinc.MessageMe.MessageMeListActivity;

public class ActionBarListActivity extends MessageMeListActivity {
    /**
    ...
    protected final ActionBarHelper mActionBarHelper = ActionBarHelper
            .createInstance(this);
    ...
    public void setMenuItemEnabled(MenuItem item, boolean enabled) {
        mActionBarHelper.setMenuItemEnabled(item, enabled);
    }
}

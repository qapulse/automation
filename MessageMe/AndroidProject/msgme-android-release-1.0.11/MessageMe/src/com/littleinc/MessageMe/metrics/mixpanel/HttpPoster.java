package com.littleinc.MessageMe.metrics.mixpanel;
...
import com.littleinc.MessageMe.metrics.mixpanel.Base64Coder;
import com.littleinc.MessageMe.metrics.mixpanel.StringUtils;
...
/* package */ class HttpPoster {
    ...
    private PostResult postHttpRequest(String endpointUrl, List<NameValuePair> nameValuePairs) {
        ...
        try {
            ...
            httppost.setHeader("User-Agent", MessageMeApplication.getUserAgent());

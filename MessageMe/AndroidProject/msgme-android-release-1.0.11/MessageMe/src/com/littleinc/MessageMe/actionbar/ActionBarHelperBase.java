...
public class ActionBarHelperBase extends ActionBarHelper {
    ...
    private void setupActionBar() {
        ...
        homeItem.setIcon(R.drawable.actionbar_top_icon_back);
    ...
    private View addActionItemCompatFromMenuItem(final MenuItem item) {
        ...
        if (item.getItemId() == R.id.menu_refresh) {
            ...
            final int indicatorWidth = indicator.getIndeterminateDrawable() != null ? indicator
                    .getIndeterminateDrawable().getIntrinsicWidth() : -1;
            final int indicatorHeight = indicator.getIndeterminateDrawable() != null ? indicator
                    .getIndeterminateDrawable().getIntrinsicHeight() : -1;
            final int indicatorMargin = mActivity.getResources()
            ...
            indicatorLayoutParams.setMargins(indicatorMargin, 0,
                    indicatorMargin, 0);
    ...
    public void setMenuItemEnabled(MenuItem item, boolean enabled) {
        ...
        for (int i = 0; i < actionBar.getChildCount(); i++) {
            ...
            if (actionBar.getChildAt(i) instanceof ImageButton) {
                if (((ImageButton) actionBar.getChildAt(i)).getId() == item
                        .getItemId()) {
                    actionBar.getChildAt(i).setEnabled(enabled);
                }
            }
        }
    }
    ...
    public void hideMenuItem(MenuItem item) {
        ...
        for (int i = 0; i < actionBar.getChildCount(); i++) {
            ...
            if (actionBar.getChildAt(i) instanceof ImageButton) {
                if (((ImageButton) actionBar.getChildAt(i)).getId() == item
                        .getItemId()) {
                    actionBar.getChildAt(i).setVisibility(View.GONE);
                }
            }
    ...
    public void showMenuitem(MenuItem item) {
        ...
        for (int i = 0; i < actionBar.getChildCount(); i++) {
            ...
            if (actionBar.getChildAt(i) instanceof ImageButton) {
                if (((ImageButton) actionBar.getChildAt(i)).getId() == item
                        .getItemId()) {
                    actionBar.getChildAt(i).setVisibility(View.VISIBLE);
                }
            }
    ...
    /*
     * Check if the first item of the ActionBarCompat is the home button,
     * if that's the case deletes the current home image, and sets a new one
     */
    @Override
    public void setHomeIcon(int resID) {
        ViewGroup actionBar = getActionBarCompat();
        if (actionBar.getChildAt(0) instanceof ImageButton) {
            ((ImageButton) actionBar.getChildAt(0)).setImageDrawable(null);
            ((ImageButton) actionBar.getChildAt(0)).setImageResource(resID);
        }
    }
    ...
    public void disableHomeButton() {
        ViewGroup actionBar = getActionBarCompat();
        if (actionBar.getChildAt(0) instanceof ImageButton) {
            ((ImageButton) actionBar.getChildAt(0)).setClickable(false);
        }
    }
}

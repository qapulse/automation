...
public abstract class CoreActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /*
         * if (hideTitlebar()) { requestWindowFeature(Window.FEATURE_NO_TITLE);
         * }
         */
    ...
    /**
     * If the subclass would like to use any auto config classes (e.g.
     * actionbar) they may override this with the resource ID of the layout to
     * use. This implementation returns -1 (no layout).
     */
    ...
    protected void setOnEnterListener(int viewId,
    ...
    public void confirmYesNo(String title, String message,
    ...
    protected void setViewText(View root, int viewId, String text) {
        ((TextView) root.findViewById(viewId))
    ...
    protected void setVisible(int viewId, boolean visible) {
        ...
        if (view != null) {            
            ...
            LogIt.w(this, "Ignore call to setVisible as view is null");
        }
    }
    ...
    protected void setHidden(int viewId, boolean visible) {
        ...
        if (view != null) {            
            ...
            LogIt.w(this, "Ignore call to setHidden as view is null");
        }
    }
    ...
    protected void setHidden(View root, int viewId, boolean visible) {
        ...
        if (view != null) {            
            ...
            LogIt.w(this, "Ignore call to setHidden/3 as view is null");
        }
    }
    ...
    public void sendEmail(String recipient, String cc, String subject,
            String body) {
    ...
    public void alert(int titleResId, int messageResId) {
        UIUtil.alert(this, getString(titleResId), getString(messageResId));
    }

    public void alert(int titleResId, String message) {
        UIUtil.alert(this, getString(titleResId), message);
    }
    ...
    /**
     * Show a message dialog with an OK button, clicking OK kills the
     * application
     */
    ...
    /**
     * Hide initial page focus by using a hidden text field. Pages should call
     * this in onCreate, and their pages require a EditText named focusHack
     */

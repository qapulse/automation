...
public class DualToneGradientDrawable extends Drawable {
    ...
    public DualToneGradientDrawable(int topColor, int topMidColor,
            int bottomMidColor, int bottomColor) {

        topDrawable = new GradientDrawable(Orientation.TOP_BOTTOM, new int[] {
                topColor, topMidColor });
        bottomDrawable = new GradientDrawable(Orientation.TOP_BOTTOM,
                new int[] { bottomMidColor, bottomColor });
    }

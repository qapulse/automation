...
public class CoreServiceCall {
    ...
    protected String makeRequest(String url, Map<String, String> paramMap)
            throws IOException {
        ...
        if (paramMap != null && paramMap.size() > 0) {
            ...
            for (Map.Entry<String, String> entry : paramMap.entrySet()) {
                queryString += URLEncoder.encode(entry.getKey())
                        + "="
                        + URLEncoder.encode(entry.getValue() != null ? entry
                                .getValue() : "") + "&";
            }
        ...
        try {
            ...
            String contentString = client.execute(get,
    ...
    protected void makeBinaryRequest(String url, File destinationFile)
            throws IOException {
        makeBinaryRequest(url, null, destinationFile);
    }

    protected void makeBinaryRequest(String url, Map<String, String> paramMap,
        ...
        try {
            ...
            client.execute(get, new LocalSavedContentResponseHandler(
                    destinationFile));
        } catch (IOException e) {
            throw e;
        } catch (Throwable t) {

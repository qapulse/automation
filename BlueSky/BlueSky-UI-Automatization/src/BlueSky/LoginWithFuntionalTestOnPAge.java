		 ...
		 while (exitCondition == true){
			 ...
			 else
			 {
				 try {
					...
					//	WebElement header = driver.findElement(By.id("headerMenu"));	
						driver.findElement(By.className("bsEbookselectedNew")).click();
						/*
						List <WebElement> navigationHome = driver.findElements(By.className("bsEbookselectedNew"));
						
						if (navigationHome.size() >0)
						{
						for(WebElement ele : navigationHome){
					        
							if (ele.getText() == "My Digital Collections")
								{ele.click();

							Thread.sleep(10000);}
							else{
								if (ele.getText() == "Favorites")
								{	ele.click();

								Thread.sleep(10000);
								}
								else{
									if (ele.getText() == "My Content")
									{	ele.click();

									Thread.sleep(10000);
									}
									else
										driver.findElement(By.className("mipatito"));
								}
							}
					      }
						}//else driver.findElement(By.className("mipatito"));
						/*Iterator<WebElement> linkinHeader=  navigationHome.iterator();
						 WebElement myinput;
						 
						 while(linkinHeader.hasNext())
					        {	
								myinput = (WebElement)linkinHeader.next();
							 	myinput.click();
							 //	Thread.sleep(10000);
					        }*/
